...
export class ModalService {
  ...
  openModal(component: Type<ModalBaseComponent>, data?: Object): Subject<Object> {
    let createdComponent: ComponentRef<ModalBaseComponent> = createComponent(component, {
    ...
    return createdComponent.instance["dataSubject"];
  }
